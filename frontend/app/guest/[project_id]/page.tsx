            ...
            <Card className="w-full max-w-2xl shadow-2xl border-2">
                ...
                <CardHeader className="text-center space-y-2">
                    <CardTitle className="text-3xl font-bold tracking-tight">
                        {uploadComplete ? "Your Images" : "Take Your Selfie"}
                    </CardTitle>
                    <CardDescription className="text-base">
                        {uploadComplete
                            ? "Download your generated images below"
                ...
                <CardContent className="space-y-6">
                    ...
                    {uploadComplete && generatedImages.length > 0 ? (
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {generatedImages.map((item: any, index: number) => (
                                    <div
                                        key={item.image.id}
                                        className="relative group rounded-lg overflow-hidden shadow-lg bg-muted aspect-square"
                                    >
                                    {/* {item.image.thumbnail_link} */}
                                        <img
                            ...
                            <div className="flex gap-3">
                                <Button onClick={resetFlow} variant="outline" size="lg" className="flex-1 h-12 bg-transparent">
